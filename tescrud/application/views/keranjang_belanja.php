            ...
            <div class="col-lg-6 col-md-6">
                <div class="table-responsive">
                    ...
                    foreach ($product as $row) {
                        echo ' <div class="col-md-4 text-center" style="padding: 16px; background-color:#fff88f; border:2px solid #ccc; margin-bottom:16px; height:350px  ">
                        <img src="' . base_url("img/"). $row->product_image . '" alt="" class="img-thumbnail" /> <br>
